...
var posts = getPosts("https://jsonplaceholder.typicode.com/posts")
    .then(function (posts) { return posts.forEach(function (post) {
    DIV.innerHTML = DIV.innerHTML +
        "<div class=\"post\">\n        <div class=\"post__id\">\n          <p class=\"post__user-id\">User ID: #".concat(post.userId, "</p>\n          <p class=\"post__id-number\">Post #").concat(post.id, "</p>\n        </div>\n        <p class=\"post__title\">").concat(post.title, "</p>\n        <p class=\"post__body\">").concat(post.body, "</p>\n      </div>");
}); });
